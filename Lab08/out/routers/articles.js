...
router.post('/', auth_1.basicAuth, permissions_1.restrictCreate, (0, koa_bodyparser_1.default)(), validation_1.validateArticle, createArticle);
router.put('/:id([0-9]{1,})', auth_1.basicAuth, permissions_1.restrictUpdate, (0, koa_bodyparser_1.default)(), validation_1.validateArticle, updateArticle);
