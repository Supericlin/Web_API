...
router.post('/', basicAuth, restrictCreate, bodyParser(), validateArticle, createArticle);
router.put('/:id([0-9]{1,})', basicAuth, restrictUpdate, bodyParser(), validateArticle, updateArticle);
